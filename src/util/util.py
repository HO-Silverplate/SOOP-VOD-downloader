...
class util:
    ...
    @classmethod
    def get_unique_filename(cls, file_path: str) -> str:
        """
        ...
        name = cls.delete_spec_char(name)
    ...
    @classmethod
    def delete_spec_char(cls, string: str):
        return re.sub(r'[\/:*?"<>|]', "", string)

    @classmethod
    def read_out_time(cls, proc: subprocess.Popen) -> Generator[int, None, None]:
        """
